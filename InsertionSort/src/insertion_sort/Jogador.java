...
public class Jogador {
    ...
    public void leitura() throws Exception {
        ...
        ArquivoTextoLeitura leituraArquivo = new ArquivoTextoLeitura("Inserção/InsertionSort/tmp/jogadores.txt");
        ...
        scanner.close();
        ArrayList<Jogador> arrayOfPlayersSorted = insertionSort.sort(newArrayOfPlayers);
