...
public class Jogador {
    ...
    public void leitura() throws Exception {
        ...
        ArquivoTextoLeitura leituraArquivo = new ArquivoTextoLeitura("Atividade 7_1/tmp/jogadores.txt");
        leituraArquivo.lerArquivo();

        Pilha pilhaDeJogadores = new Pilha(4000);
        ...
        while (!entrada.equals("FIM")) {
            ...
            for (Jogador jogador : arrayOfPlayers) {
                if (playerId == jogador.id) {
                    try {
                        pilhaDeJogadores.empilhar(jogador);
                    } catch (Exception e) {
        ...
        for (int i = 0; i < qtdJogadores; i++) {
            ...
            if (entrada.equals("R")) {
                ...
                try {
                    desempilhado = pilhaDeJogadores.desempilhar();
